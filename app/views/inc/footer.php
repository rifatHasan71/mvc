    <div id="footer">
        <div class="container bg-dark my-3 rounded p-4  ">
          <h4 class="text-center text-white">This is footer</h4>
        </div>
    </div>
  ...
  <script src="<?php  echo BASE_URL.'app/views/js/script.js'; ?>"></script>
</body>
</html>